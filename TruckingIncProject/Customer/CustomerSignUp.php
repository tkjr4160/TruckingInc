...
<body>
	<div class="Div">
		<a href="CustomerSignIn.php">Already have an account? Sign in here</a></br>
	...
	<form action="CustomerSignUpHelper.php" method="post" class="Form">
		<div class="FormDiv">
			...
			<p class="FormDivPar">
				...
				<input type="text" id="CustomerRepeatPassword" name="CustomerRepeatPassword" class="FormDivParText" size="20" maxlength="30"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">First Name: </label>
				<input type="text" id="CustomerFirstName" name="CustomerFirstName" class="FormDivParText" size="20" maxlength="30"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">Middle Initial: </label>
				<input type="text" id="CustomerMiddleInitial" name="CustomerMiddleInitial" class="FormDivParText" size="2" maxlength="1"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">Last Name: </label>
				<input type="text" id="CustomerLastName" name="CustomerLastName" class="FormDivParText" size="20" maxlength="30"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">Street: </label>
				<input type="text" id="CustomerStreet" name="CustomerStreet" class="FormDivParText" size="20" maxlength="30"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">City: </label>
				<input type="text" id="CustomerCity" name="CustomerCity" class=""FormDivParText size="20" maxlength="30"/>
			</p>
			<p class="FormDivPar">
			...
			<p class="FormDivPar">
				...
				<input type="text" id="CustomerZip" name="CustomerZip" class="FormDivParText" size="15" maxlength="10"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">Phone: </label>
				<input type="text" id="CustomerPhone" name="CustomerPhone" class="FormDivParText" size="15" maxlength="12"/>
			</p>
			<p class="FormDivPar">
				<label class="FormDivParLabel">Email: </label>
				<input type="text" id="CustomerEmail" name="CustomerEmail" class="FormDivParText" size="20" maxlength="50"/>
			</p>
			<p class="FormDivPar">
