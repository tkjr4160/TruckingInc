	...
	<form action="CustomerAccountHelper.php" method="post" class="Form">
		<div class="FormDiv">
			...
			<?php
					...
					<td align="left"><input type="text" name="zipChange" class="FormDivTableTrTdText" value="' . $row['zip'] . '" size="15" maxlength="10"/></td>
					<td align="left"><input type="text" name="phoneChange" class="FormDivTableTrTdText" value="' . $row['phone'] . '" size="15" maxlength="12"/></td>
					<td align="left"><input type="text" name="emailChange" class="FormDivTableTrTdText" value="' . $row['email'] . '" size="20" maxlength="50"/></td>
