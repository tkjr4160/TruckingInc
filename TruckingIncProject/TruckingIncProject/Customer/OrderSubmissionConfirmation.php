...
<body>
	...
	<div class="wrapper" style="height: 380px;">
		...
		<div id="form" class="FormDiv">
			<div>
				<h3 style="text-align:center;"><u>Thank you for your business!</u></h3>
			</div>
			<form action="CustomerCreateOrder.php" class="Form" style="width:20%; margin:0 auto;">
