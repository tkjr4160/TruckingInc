...
<head>
    ...
    if(card.checkValidity() && num>=51 && num<=55 || card.checkValidity() && num>=2221 && num<=2720)
      ...
      var numUnits = $('NumberUnits');
      if (numUnits.checkValidity())
      {
        numUnits.innerHTML = '';
      }
      else
      {
        numUnits.innerHTML = card.validationMessage;
      }
    </script>
</head>
                ...
                <div class="FormDiv">
                    ...
                    <table class="table-input" style="width:50%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="LumberType" name="LumberType<?php $row['lumberType'] ?>" required>
                                    <option selected="true" disabled="disabled" value="">Select Lumber Type</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <input title="This must be an integer less than 1000." type="text" id="NumberUnits" name="NumberUnits" class="FormDivParSel" size="5" pattern="[0-9]{1,3}" required/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label class="FormDivParLabel">Expiration: </label>
                            </td>
                            <td>
                                <input type="text" id="Expiration" name="Expiration" class="FormDivParSel" size="3" maxlength="5" placeholder="mm/yy" pattern="[0-9]{2}\/[0-9]{2}" required/>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div>
                            ...
                            <table class="table-input" cellspacing="3" cellpadding="3" width="50%" height="50%">
                                <tr>
                                    <td><b>Lumber Type:</td>
                                    <td id="lumberType"></td>
                                </tr>
