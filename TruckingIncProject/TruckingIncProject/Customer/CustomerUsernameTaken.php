...
<head>
  <title>Customer Username Taken</title>
  <meta charset="utf-8" />
...
<body>
  ...
  <div class="wrapper" style="height: 380px;">
    ...
    <form action="../TruckingIncHome.php" method="post" style="text-align:center;">
      <p>Something has gone wrong! You most likely entered a username that has been taken.</p>
