    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <?php if ($fetchPermissionsCheck[0] == 'A' || $fetchPermissionsCheck[0] == 'B') {echo '<li><a class="active" href="EmployeeAssignTruck.php">Truck Management</a></li>';}?>
        ...
        <div id="form">
                        ...
                        <tr>
                            <td>
                                <select name="ChangeEmployee<?php $row2['employeeID'] ?>" required>
                                    <option disabled selected="true" value="">Select an Employee</option>
                                    <?php echo $employeeList ?>
                                </select>
                            </td>
                            <td>
                                <select name="ChangeTruck<?php $row2['truckID'] ?>" required>
                                    <option disabled selected="true" value="">Select a Truck</option>
                                    <?php echo $truckList ?>
                                </select>
                            </td>
                ...
                <div class="accountInfo-form">
                    <table class="table-input" style="width:60%;">
                        <tr>
                            ...
                            <td>
                                <select id="TruckMake" name="TruckMake" class="FormDivParSel" required>
                                    <option value="" disabled="disabled" selected="true">Select Make</option
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="color" id="TruckColor" name="TruckColor" class="FormDivParText" size="15" maxlength="30" required/>
                            </td>
                        <tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input title="Year must be a four digit number." type="text" id="TruckYear" name="TruckYear" class="FormDivParText" size="15" maxlength="4" pattern="[0-9]{4}" required/>
                            </td>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="LicenseNum" name="LicenseNum" class="FormDivParText" size="15" maxlength="8" required/>
                            </td>
                        <tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input title="Purchase Price must be numeric." type="text" id="PurchasePrice" name="PurchasePrice" class="FormDivParText" size="15" maxlength="6" pattern="[0-9]{1,6}" required/>
                            </td>
                        <tr>
                            <td colspan="2">
            ...
            <div class="accountInfo-form">
				...
				<tr>
					...
					<td>' . $row['dt'] . '</td>
					<td>' . $row['licenseNo'] . '</td>
					<td>$' . number_format($row['priceBoughtFor'], 2) . '</td>
					<td>' . $row['inUse'] . '</td>
