...
<head>
  <title>Assign Truck Error</title>
  <meta charset="utf-8" />
...
<body>
  ...
  <div class="wrapper" style="height: 380px;">
    ...
    <form action="EmployeeAssignTruck.php" method="post" style="width:20%; margin:0 auto;text-align:center;">
      <p>Something Went Wrong! Make sure you fill out all fields necessary.</p>
