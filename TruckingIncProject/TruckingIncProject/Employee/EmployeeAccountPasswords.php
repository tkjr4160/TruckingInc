...
<header>
  ...
  <div class="wrapper" style="height: 380px;">
    ...
    <form action="EmployeeAccount.php" method="post" style="width:20%; margin:0 auto;text-align:center;">
      <p>You must have the correct current password, and your new passwords must match.</p>
